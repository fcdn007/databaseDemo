...
(function (factory) {
    ...
    _registerModule(_modules, 'annotations/eventEmitterMixin.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
         ...
         *
         * */
        var addEvent = U.addEvent, inArray = U.inArray, objectEach = U.objectEach, pick = U.pick,
        ...
        var eventEmitterMixin = {
            ...
            onMouseUp: function (_e) {
                var chart = this.chart, annotation = this.target || this,
                    annotationsOptions = chart.options.annotations, index = chart.annotations.indexOf(annotation);
            ...
            mouseMoveToRadians: function (e, cx, cy) {
                var prevDy = e.prevChartY - cy, prevDx = e.prevChartX - cx, dy = e.chartY - cy, dx = e.chartX - cx,
                    temp;
            ...
            mouseMoveToScale: function (e, cx, cy) {
                var prevDx = e.prevChartX - cx, prevDy = e.prevChartY - cy, dx = e.chartX - cx, dy = e.chartY - cy,
                    sx = (dx || 1) / (prevDx || 1), sy = (dy || 1) / (prevDy || 1), temp;
                if (this.chart.inverted) {
                    temp = sy;
                    sy = sx;
                    sx = temp;
    ...
    _registerModule(_modules, 'annotations/ControlPoint.js', [_modules['parts/Utilities.js'], _modules['annotations/eventEmitterMixin.js']], function (U, eventEmitterMixin) {
        ...
        ControlPoint.prototype.update = function (userOptions) {
            var chart = this.chart, target = this.target, index = this.index,
    ...
    _registerModule(_modules, 'annotations/MockPoint.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        extend(MockPoint.prototype, /** @lends Highcharts.AnnotationMockPoint# */ {
            ...
            isInsidePane: function () {
                var plotX = this.plotX, plotY = this.plotY, xAxis = this.series.xAxis, yAxis = this.series.yAxis,
                    isInside = true;
                if (xAxis) {
    ...
    _registerModule(_modules, 'annotations/controllable/controllableMixin.js', [_modules['parts/Utilities.js'], _modules['annotations/ControlPoint.js'], _modules['annotations/MockPoint.js'], _modules['parts/Tooltip.js']], function (U, ControlPoint, MockPoint, Tooltip) {
        ...
        var controllableMixin = {
             ...
             */
            linkPoints: function () {
                var pointsOptions = this.getPointsOptions(), points = this.points,
                    len = (pointsOptions && pointsOptions.length) || 0, i, point;
                for (i = 0; i < len; i++) {
            ...
            update: function (newOptions) {
                var annotation = this.annotation, options = merge(true, this.options, newOptions),
    ...
    _registerModule(_modules, 'annotations/controllable/markerMixin.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        var markerMixin = {
            ...
            setItemMarkers: function (item) {
                var itemOptions = item.options, chart = item.chart, defs = chart.options.defs, fill = itemOptions.fill,
    ...
    _registerModule(_modules, 'annotations/controllable/ControllablePath.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['annotations/controllable/controllableMixin.js'], _modules['annotations/controllable/markerMixin.js']], function (H, U, controllableMixin, markerMixin) {
        ...
        merge(true, ControllablePath.prototype, controllableMixin, /** @lends Highcharts.AnnotationControllablePath# */ {
            ...
            toD: function () {
                ...
                var points = this.points, len = points.length, showPath = len, point = points[0],
                    position = showPath && this.anchor(point).absolutePosition, pointIndex = 0, dIndex = 2, command;
    ...
    _registerModule(_modules, 'annotations/controllable/ControllableLabel.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['annotations/controllable/controllableMixin.js'], _modules['annotations/MockPoint.js'], _modules['parts/Tooltip.js']], function (H, U, controllableMixin, MockPoint, Tooltip) {
        ...
        ControllableLabel.alignedPosition = function (alignOptions, box) {
            var align = alignOptions.align, vAlign = alignOptions.verticalAlign,
                x = (box.x || 0) + (alignOptions.x || 0), y = (box.y || 0) + (alignOptions.y || 0), alignFactor,
                vAlignFactor;
            if (align === 'right') {
                alignFactor = 1;
        ...
        ControllableLabel.justifiedOptions = function (chart, label, alignOptions, alignAttr) {
            var align = alignOptions.align, verticalAlign = alignOptions.verticalAlign,
                padding = label.box ? 0 : (label.padding || 0), bBox = label.getBBox(), off,
                //
                options = {
                    align: align,
            ...
            /** @lends Annotation.ControllableLabel# */ {
                ...
                translate: function (dx, dy) {
                    var chart = this.annotation.chart,
                        ...
                        // Chart.options.annotations
                        annotationIndex = chart.annotations.indexOf(this.annotation),
                        chartAnnotations = chart.options.annotations, chartOptions = chartAnnotations[annotationIndex],
                        temp;
                    if (chart.inverted) {
                        temp = dx;
                        dx = dy;
                ...
                redraw: function (animation) {
                    var options = this.options, text = this.text || options.format || options.text,
                        label = this.graphic, point = this.points[0], show = false, anchor, attrs;
                    label.attr({
                        text: text ?
                 ...
                 */
                anchor: function () {
                    var anchor = controllableMixin.anchor.apply(this, arguments), x = this.options.x || 0,
                        y = this.options.y || 0;
                ...
                position: function (anchor) {
                    var item = this.graphic, chart = this.annotation.chart, point = this.points[0],
                        itemOptions = this.options, anchorAbsolutePosition = anchor.absolutePosition,
                        anchorRelativePosition = anchor.relativePosition, itemPosition, alignTo, itemPosRelativeX,
                        itemPosRelativeY, showItem = point.series.visible &&
        ...
        H.SVGRenderer.prototype.symbols.connector = function (x, y, w, h, options) {
            var anchorX = options && options.anchorX, anchorY = options && options.anchorY, path, yOffset,
                lateral = w / 2;
    ...
    _registerModule(_modules, 'annotations/annotations.src.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['annotations/controllable/controllableMixin.js'], _modules['annotations/controllable/ControllableRect.js'], _modules['annotations/controllable/ControllableCircle.js'], _modules['annotations/controllable/ControllablePath.js'], _modules['annotations/controllable/ControllableImage.js'], _modules['annotations/controllable/ControllableLabel.js'], _modules['annotations/eventEmitterMixin.js'], _modules['annotations/MockPoint.js'], _modules['annotations/ControlPoint.js']], function (H, U, controllableMixin, ControllableRect, ControllableCircle, ControllablePath, ControllableImage, ControllableLabel, eventEmitterMixin, MockPoint, ControlPoint) {
         ...
         *
         * */
        var addEvent = U.addEvent, defined = U.defined, destroyObjectProperties = U.destroyObjectProperties,
            erase = U.erase, extend = U.extend, find = U.find, merge = U.merge, pick = U.pick, splat = U.splat,
            wrap = U.wrap;
        ...
        merge(true, Annotation.prototype, controllableMixin, eventEmitterMixin,
            /** @lends Highcharts.Annotation# */
            {
                ...
                setClipAxes: function () {
                    var xAxes = this.chart.xAxis, yAxes = this.chart.yAxis,
                        linkedAxes = reduce((this.options.labels || []).concat(this.options.shapes || []), function (axes, labelOrShape) {
                            return [
                                xAxes[labelOrShape &&
                                labelOrShape.point &&
    ...
    _registerModule(_modules, 'annotations/types/Tunnel.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        var merge = U.merge;
        var Annotation = H.Annotation, CrookedLine = Annotation.types.crookedLine,
            ControlPoint = Annotation.ControlPoint, MockPoint = Annotation.MockPoint;
    ...
    _registerModule(_modules, 'annotations/types/InfinityLine.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        InfinityLine.findEdgePoint = function (firstPoint, secondPoint) {
            var xAxis = firstPoint.series.xAxis, yAxis = secondPoint.series.yAxis,
                ...
                deltaX = secondPointPixels.x - firstPointPixels.x, deltaY = secondPointPixels.y - firstPointPixels.y,
                xAxisMin = xAxis.left, xAxisMax = xAxisMin + xAxis.width, yAxisMin = yAxis.top,
                yAxisMax = yAxisMin + yAxis.height, xLimit = deltaX < 0 ? xAxisMin : xAxisMax,
        ...
        var createPathDGenerator = function (retracementIndex, isBackground) {
            return function () {
                var annotation = this.annotation,
                    ...
                    rightTop = this.anchor(annotation.endRetracements[retracementIndex]).absolutePosition, d = [
                        'M',
        ...
        H.extendAnnotation(Fibonacci, Tunnel, {
                ...
                linkRetracementsPoints: function () {
                    var points = this.points, startDiff = points[0].y - points[3].y, endDiff = points[1].y - points[2].y,
                        startX = points[0].x, endX = points[1].x;
    ...
    _registerModule(_modules, 'annotations/types/Pitchfork.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        Pitchfork.findEdgePoint = function (point, firstAnglePoint, secondAnglePoint) {
            var angle = Math.atan2(secondAnglePoint.plotY - firstAnglePoint.plotY, secondAnglePoint.plotX - firstAnglePoint.plotX),
                distance = 1e7;
            return {
    ...
    _registerModule(_modules, 'annotations/types/VerticalLine.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        VerticalLine.connectorSecondPoint = function (target) {
            var annotation = target.annotation, typeOptions = annotation.options.typeOptions,
                point = annotation.points[0], yOffset = typeOptions.yOffset, xy = MockPoint.pointToPixels(point, true),
        ...
        H.extendAnnotation(VerticalLine, null, {
                ...
                addLabels: function () {
                    var typeOptions = this.options.typeOptions, labelOptions = typeOptions.label, x = 0,
                        y = labelOptions.offset, verticalAlign = labelOptions.offset < 0 ? 'bottom' : 'top',
                        align = 'center';
                    if (this.chart.inverted) {
    ...
    _registerModule(_modules, 'annotations/types/Measure.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        H.extendAnnotation(Measure, null, {
                ...
                addCrosshairs: function () {
                    var chart = this.chart, options = this.options.typeOptions, point = this.options.typeOptions.point,
                        xAxis = chart.xAxis[options.xAxis], yAxis = chart.yAxis[options.yAxis], inverted = chart.inverted,
                        xAxisMin = xAxis.toPixels(this.xAxisMin), xAxisMax = xAxis.toPixels(this.xAxisMax),
                        yAxisMin = yAxis.toPixels(this.yAxisMin), yAxisMax = yAxis.toPixels(this.yAxisMax),
                        defaultOptions = {
                            point: point,
                            type: 'path'
                ...
                onDrag: function (e) {
                    var translation = this.mouseMoveToTranslation(e), selectType = this.options.typeOptions.selectType,
                        x = selectType === 'y' ? 0 : translation.x, y = selectType === 'x' ? 0 : translation.y;
                    this.translate(x, y);
                    this.offsetX += x;
                    this.offsetY += y;
                ...
                calculations: {
                     ...
                     */
                    init: function () {
                        var options = this.options.typeOptions, chart = this.chart,
                            getPointPos = this.calculations.getPointPos, inverted = chart.inverted,
                            xAxis = chart.xAxis[options.xAxis], yAxis = chart.yAxis[options.yAxis],
                            bck = options.background, width = inverted ? bck.height : bck.width,
                            height = inverted ? bck.width : bck.height, selectType = options.selectType,
                    ...
                    recalculate: function (resize) {
                        var calc = this.calculations, options = this.options.typeOptions,
                            xAxis = this.chart.xAxis[options.xAxis], yAxis = this.chart.yAxis[options.yAxis],
                            getPointPos = this.calculations.getPointPos, offsetX = this.offsetX, offsetY = this.offsetY;
                    ...
                    updateStartPoints: function (redraw, resize, cpIndex, dx, dy) {
                        var options = this.options.typeOptions, selectType = options.selectType,
                            xAxis = this.chart.xAxis[options.xAxis], yAxis = this.chart.yAxis[options.yAxis],
                            getPointPos = this.calculations.getPointPos, startXMin = this.startXMin,
                            startXMax = this.startXMax, startYMin = this.startYMin, startYMax = this.startYMax,
                     ...
                     */
                    min: function () {
                        var min = Infinity, series = this.chart.series,
                    ...
                    max: function () {
                        var max = -Infinity, series = this.chart.series,
                            ext = this.calculations.getExtremes(this.xAxisMin, this.xAxisMax, this.yAxisMin, this.yAxisMax),
                            isCalculated = false; // to avoid Infinity in formatter
                        series.forEach(function (serie) {
                            if (serie.visible &&
                    ...
                    bins: function () {
                        var bins = 0, series = this.chart.series,
                            ext = this.calculations.getExtremes(this.xAxisMin, this.xAxisMax, this.yAxisMin, this.yAxisMax),
                            isCalculated = false; // to avoid Infinity in formatter
                        series.forEach(function (serie) {
                            if (serie.visible &&
             ...
             */
            {
                ...
                controlPointOptions: {
                    positioner: function (target) {
                        var cpIndex = this.index, chart = target.chart, options = target.options,
                            typeOptions = options.typeOptions, selectType = typeOptions.selectType,
                            controlPointOptions = options.controlPointOptions, inverted = chart.inverted,
                            xAxis = chart.xAxis[typeOptions.xAxis], yAxis = chart.yAxis[typeOptions.yAxis],
                            targetX = target.xAxisMax, targetY = target.yAxisMax,
                    ...
                    events: {
                        drag: function (e, target) {
                            var translation = this.mouseMoveToTranslation(e),
                                selectType = target.options.typeOptions.selectType, index = this.index,
                                x = selectType === 'y' ? 0 : translation.x, y = selectType === 'x' ? 0 : translation.y;
    ...
    _registerModule(_modules, 'annotations/navigationBindings.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['mixins/navigation.js']], function (H, U, chartNavigationMixin) {
        ...
        var addEvent = U.addEvent, attr = U.attr, extend = U.extend, format = U.format, fireEvent = U.fireEvent,
            isArray = U.isArray, isFunction = U.isFunction, isNumber = U.isNumber, isObject = U.isObject,
        ...
        extend(H.NavigationBindings.prototype, {
             ...
             */
            initEvents: function () {
                var navigation = this, chart = navigation.chart, bindingsContainer = navigation.container,
            ...
            fieldsToOptions: function (fields, config) {
                objectEach(fields, function (value, field) {
                    var parsedValue = parseFloat(value), path = field.split('.'), parent = config,
            ...
            annotationToFields: function (annotation) {
                var options = annotation.options, editables = H.NavigationBindings.annotationsEditable,
                    nestedEditables = editables.nestedOptions, getFieldType = this.utils.getFieldType,
                    type = pick(options.type, options.shapes && options.shapes[0] &&
                        options.shapes[0].type, options.labels && options.labels[0] &&
                        options.labels[0].itemType, 'label'),
                    nonEditables = H.NavigationBindings.annotationsNonEditable[options.langKey] || [], visualOptions = {
            ...
            navigation: {
                ...
                bindings: {
                    ...
                    circleAnnotation: {
                        ...
                        start: function (e) {
                            var coords = this.chart.pointer.getCoordinates(e),
                                navigation = this.chart.options.navigation, controlPoints = [{
                                    positioner: function (target) {
                    ...
                    rectangleAnnotation: {
                        ...
                        start: function (e) {
                            var coords = this.chart.pointer.getCoordinates(e),
                                navigation = this.chart.options.navigation, x = coords.xAxis[0].value,
                                y = coords.yAxis[0].value, controlPoints = [{
                                    ...
                                    events: {
                                        drag: function (target) {
                                            var coords = this.chart.pointer.getCoordinates(e), x = coords.xAxis[0].value,
                                                y = coords.yAxis[0].value, shape = target.options.shapes[0],
                                                points = shape.points;
                                            // Top right point
                                            points[1].x = x;
                        ...
                        steps: [
                            function (e, annotation) {
                                var points = annotation.options.shapes[0].points,
                                    coords = this.chart.pointer.getCoordinates(e), x = coords.xAxis[0].value,
                                    y = coords.yAxis[0].value;
                                // Top right point
                                points[1].x = x;
                                // Bottom right point (cursor position)
    ...
    _registerModule(_modules, 'annotations/popup.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
         ...
         *
         * */
        var addEvent = U.addEvent, createElement = U.createElement, defined = U.defined, isArray = U.isArray,
            isObject = U.isObject, isString = U.isString, objectEach = U.objectEach, pick = U.pick, wrap = U.wrap;
        var indexFilter = /\d/g, PREFIX = 'highcharts-', DIV = 'div', INPUT = 'input', LABEL = 'label',
            BUTTON = 'button', SELECT = 'select', OPTION = 'option', SPAN = 'span', UL = 'ul', LI = 'li', H3 = 'h3';
        /* eslint-disable no-invalid-this, valid-jsdoc */
        ...
        H.Popup.prototype = {
            ...
            addInput: function (option, type, parentDiv, value) {
                var optionParamList = option.split('.'), optionName = optionParamList[optionParamList.length - 1],
                    lang = this.lang, inputName = PREFIX + type + '-' + optionName;
            ...
            getFields: function (parentDiv, type) {
                var inputList = parentDiv.querySelectorAll('input'),
                    ...
                    volumeTo = parentDiv.querySelectorAll(optionVolume)[0], seriesId, param, fieldsOutput;
                fieldsOutput = {
                    actionType: type,
            ...
            annotations: {
                ...
                addToolbar: function (chart, options, callback) {
                    var _self = this, lang = this.lang, popupDiv = this.popup.container, showForm = this.showForm,
                        toolbarClass = PREFIX + 'annotation-toolbar', button;
                    // set small size
                ...
                addFormFields: function (parentDiv, chart, parentNode, options, storage, isRoot) {
                    var _self = this, addFormFields = this.annotations.addFormFields, addInput = this.addInput,
                        lang = this.lang, parentFullName, titleName;
            ...
            indicators: {
                ...
                addIndicatorList: function (chart, parentDiv, listType) {
                    var _self = this, lhsCol = parentDiv.querySelectorAll('.' + PREFIX + 'popup-lhs-col')[0],
                        rhsCol = parentDiv.querySelectorAll('.' + PREFIX + 'popup-rhs-col')[0],
                        isEdit = listType === 'edit', series = (isEdit ?
                ...
                addParamInputs: function (chart, parentNode, fields, type, parentDiv) {
                    var _self = this, addParamInputs = this.indicators.addParamInputs, addInput = this.addInput,
                        parentFullName;
            ...
            tabs: {
                ...
                switchTabs: function (disableTab) {
                    var _self = this, popupDiv = this.popup.container,
                        tabs = popupDiv.querySelectorAll('.' + PREFIX + 'tab-item'), dataParam;
