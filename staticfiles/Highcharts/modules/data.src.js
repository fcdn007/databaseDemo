    ...
    _registerModule(_modules, 'modules/data.src.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (Highcharts, U) {
        ...
        extend(Data.prototype, {
            ...
            getColumnDistribution: function () {
                var chartOptions = this.chartOptions, options = this.options, xColumns = [],
            ...
            parseCSV: function (inOptions) {
                var self = this, options = inOptions || this.options, csv = options.csv, columns,
                    ...
                    startColumn = (typeof options.startColumn !== 'undefined' &&
                        options.startColumn) ? options.startColumn : 0,
                    endColumn = options.endColumn || Number.MAX_VALUE, itemDelimiter, lines, rowIt = 0,
                    // activeRowNo = 0,
                    dataTypes = [],
                ...
                */
                ...
                function deduceDateFormat(data, limit) {
                    var format = 'YYYY/mm/dd', thing, guessedFormat = [], calculatedFormat, i = 0,
                        madeDeduction = false,
                        // candidates = {},
                        stable = [], max = [], j;
             ...
             */
            parseTable: function () {
                var options = this.options, table = options.table, columns = this.columns,
                    startRow = options.startRow || 0, endRow = options.endRow || Number.MAX_VALUE,
                    startColumn = options.startColumn || 0, endColumn = options.endColumn || Number.MAX_VALUE;
                if (table) {
             ...
             */
            complete: function () {
                var columns = this.columns, xColumns = [], type, options = this.options, series, data, i, j, r,
                    seriesIndex, chartOptions, allSeriesBuilders = [], builder, freeIndexes, typeCol, index;
