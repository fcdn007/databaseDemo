...
seriesType('organization', 'sankey',
     ...
     */
    {
        ...
        pointAttribs: function (point, state) {
            var series = this, attribs = base.pointAttribs.call(series, point, state),
        ...
        translateLink: function (point) {
            var fromNode = point.fromNode, toNode = point.toNode,
                crisp = Math.round(this.options.linkLineWidth) % 2 / 2, x1 = Math.floor(fromNode.shapeArgs.x +
        ...
        alignDataLabel: function (point, dataLabel, options) {
            ...
            if (options.useHTML) {
                var width = point.shapeArgs.width, height = point.shapeArgs.height,
