...
var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, defined = U.defined, isNumber = U.isNumber,
    merge = U.merge, objectEach = U.objectEach, pick = U.pick, seriesType = U.seriesType;
...
seriesType('timeline', 'line',
     ...
     */
    {
        ...
        alignDataLabel: function (point, dataLabel, options, alignTo) {
            var series = this, isInverted = series.chart.inverted,
                ...
                dataLabelsOptions = series.options.dataLabels, userDLOptions = point.userDLOptions || {},
                ...
                multiplier = dataLabelsOptions.alternate ?
                    (isFirstOrLast ? 1.5 : 2) :
                    1, distance, availableSpace = Math.floor(series.xAxis.len / visiblePointsCount),
                pad = dataLabel.padding, targetDLWidth, styles;
     ...
     */
    {
        ...
        getConnectorPath: function () {
            var point = this, chart = point.series.chart, xAxisLen = point.series.xAxis.len, inverted = chart.inverted,
                direction = inverted ? 'x2' : 'y2', dl = point.dataLabel, targetDLPos = dl.targetPosition, coords = {
                    x1: point.plotX,
                    y1: point.plotY,
                    x2: point.plotX,
