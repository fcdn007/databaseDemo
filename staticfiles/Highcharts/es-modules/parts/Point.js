 ...
 */
'';
var animObject = U.animObject, defined = U.defined, erase = U.erase, extend = U.extend, format = U.format,
    getNestedProperty = U.getNestedProperty, isArray = U.isArray, isNumber = U.isNumber, isObject = U.isObject,
    syncTimeout = U.syncTimeout, pick = U.pick, removeEvent = U.removeEvent, uniqueKey = U.uniqueKey;
...
var Point = /** @class */ (function () {
    ...
    Point.prototype.animateBeforeDestroy = function () {
        var point = this, animateParams = {x: point.startXPos, opacity: 0}, isDataLabel,
    ...
    Point.prototype.optionsToObject = function (options) {
        var ret = {}, series = this.series, keys = series.options.keys,
            pointArrayMap = keys || series.pointArrayMap || ['y'], valueCount = pointArrayMap.length, firstItemType,
            i = 0, j = 0;
    ...
    Point.prototype.tooltipFormatter = function (pointFormat) {
        ...
        var series = this.series, seriesTooltipOptions = series.tooltipOptions,
            valueDecimals = pick(seriesTooltipOptions.valueDecimals, ''),
            valuePrefix = seriesTooltipOptions.valuePrefix || '', valueSuffix = seriesTooltipOptions.valueSuffix || '';
