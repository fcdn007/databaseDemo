...
var clamp = U.clamp, correctFloat = U.correctFloat, defined = U.defined,
    destroyObjectProperties = U.destroyObjectProperties, extend = U.extend, isNumber = U.isNumber, merge = U.merge,
...
var Tick = /** @class */ (function () {
    ...
    Tick.prototype.moveLabel = function (str, labelOptions) {
        var tick = this, label = tick.label, moved = false, xAxis = tick.axis, chart = xAxis.chart, labelPos,
            reversed = xAxis.reversed, inverted = chart.inverted, xPos, yPos;
    ...
    Tick.prototype.replaceMovedLabel = function () {
        var tick = this, label = tick.label, axis = tick.axis, reversed = axis.reversed, chart = tick.axis.chart,
            inverted = chart.inverted, x, y;
        // Animate and destroy
        if (label && !tick.isNew) {
