...
var addEvent = U.addEvent, clamp = U.clamp, defined = U.defined, fireEvent = U.fireEvent, isNumber = U.isNumber,
    merge = U.merge, pick = U.pick, relativeLength = U.relativeLength, seriesType = U.seriesType,
    setAnimation = U.setAnimation;
var CenteredSeriesMixin = H.CenteredSeriesMixin, getStartAndEndRadians = CenteredSeriesMixin.getStartAndEndRadians,
    noop = H.noop, Series = H.Series, seriesTypes = H.seriesTypes;
/**
 * Pie series type.
 *
 * @private
...
seriesType('pie', 'line',
     ...
     */
    {
        ...
        updateTotals: function () {
            var i, total = 0, points = this.points, len = points.length, point,
        ...
        translate: function (positions) {
            ...
            var series = this, cumulative = 0, precision = 1000, // issue #172
                ...
                connectorOffset = slicedOffset + (options.borderWidth || 0), finalConnectorOffset, start, end, angle,
                ...
                ignoreHiddenPoint = options.ignoreHiddenPoint, i, len = points.length, point;
        ...
        redrawPoints: function () {
            var series = this, chart = series.chart, renderer = chart.renderer, groupTranslation, graphic, pointAttr,
                shapeArgs, shadow = series.options.shadow;
            this.drawEmpty();
     ...
     */
    {
        ...
        connectorShapes: {
            ...
            fixedOffset: function (labelPosition, connectorPosition, options) {
                var breakAt = connectorPosition.breakAt, touchingSliceAt = connectorPosition.touchingSliceAt,
            ...
            crookedLine: function (labelPosition, connectorPosition, options) {
                var touchingSliceAt = connectorPosition.touchingSliceAt, series = this.series,
                    pieCenterX = series.center[0], plotWidth = series.chart.plotWidth, plotLeft = series.chart.plotLeft,
                    alignment = labelPosition.alignment, radius = this.shapeArgs.r, crookDistance = relativeLength(// % to fraction
        ...
        getConnectorPath: function () {
            var labelPosition = this.labelPosition, options = this.series.options.dataLabels,
                connectorShape = options.connectorShape, predefinedShapes = this.connectorShapes;
