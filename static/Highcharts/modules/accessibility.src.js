...
(function (factory) {
    ...
    _registerModule(_modules, 'modules/accessibility/KeyboardNavigationHandler.js', [_modules['parts/Utilities.js']], function (U) {
        ...
        KeyboardNavigationHandler.prototype = {
             ...
             */
            run: function (e) {
                var keyCode = e.which || e.keyCode, response = this.response.noHandler,
    ...
    _registerModule(_modules, 'modules/accessibility/KeyboardNavigation.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/utils/htmlUtilities.js'], _modules['modules/accessibility/utils/EventProvider.js']], function (H, U, HTMLUtilities, EventProvider) {
        ...
        KeyboardNavigation.prototype = {
            ...
            init: function (chart, components) {
                ...
                ep.addEvent(chart.renderTo, 'keydown', function (e) {
                    return _this.onKeydown(e);
                });
                ep.addEvent(chart.container, 'focus', function (e) {
            ...
            update: function (order) {
                var a11yOptions = this.chart.options.accessibility,
                    keyboardOptions = a11yOptions && a11yOptions.keyboardNavigation, components = this.components;
            ...
            updateContainerTabindex: function () {
                var a11yOptions = this.chart.options.accessibility,
                    ...
                    container = this.chart.container, curTabindex = container.getAttribute('tabIndex');
    ...
    _registerModule(_modules, 'modules/accessibility/components/LegendComponent.js', [_modules['parts/Globals.js'], _modules['parts/Legend.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/AccessibilityComponent.js'], _modules['modules/accessibility/KeyboardNavigationHandler.js'], _modules['modules/accessibility/utils/htmlUtilities.js']], function (H, Legend, U, AccessibilityComponent, KeyboardNavigationHandler, HTMLUtilities) {
        ...
        extend(LegendComponent.prototype, /** @lends Highcharts.LegendComponent */ {
            ...
            addLegendProxyGroup: function () {
                var a11yOptions = this.chart.options.accessibility,
                    groupLabel = this.chart.langFormat('accessibility.legend.legendLabel', {}),
            ...
            onKbdArrowKey: function (keyboardNavigationHandler, keyCode) {
                var keys = this.keyCodes, response = keyboardNavigationHandler.response, chart = this.chart,
                    a11yOptions = chart.options.accessibility, numItems = chart.legend.allItems.length,
            ...
            shouldHaveLegendNavigation: function () {
                var chart = this.chart, legendOptions = chart.options.legend || {},
            ...
            onKbdNavigationInit: function (direction) {
                var chart = this.chart, lastIx = chart.legend.allItems.length - 1,
    ...
    _registerModule(_modules, 'modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js', [_modules['parts/Globals.js'], _modules['parts/Point.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/KeyboardNavigationHandler.js'], _modules['modules/accessibility/utils/EventProvider.js'], _modules['modules/accessibility/utils/chartUtilities.js']], function (H, Point, U, KeyboardNavigationHandler, EventProvider, ChartUtilities) {
        ...
        H.Chart.prototype.highlightAdjacentPoint = function (next) {
            var chart = this, series = chart.series, curPoint = chart.highlightedPoint,
        ...
        H.Chart.prototype.highlightAdjacentSeries = function (down) {
            var chart = this, newSeries, newPoint, adjacentNewPoint, curPoint = chart.highlightedPoint,
                lastSeries = chart.series && chart.series[chart.series.length - 1],
                lastPoint = lastSeries && lastSeries.points &&
        ...
        H.Chart.prototype.highlightAdjacentPointVertical = function (down) {
            ...
            this.series.forEach(function (series) {
                ...
                series.points.forEach(function (point) {
                    ...
                    var yDistance = point.plotY - curPoint.plotY, width = Math.abs(point.plotX - curPoint.plotX),
        ...
        extend(SeriesKeyboardNavigation.prototype, /** @lends Highcharts.SeriesKeyboardNavigation */ {
            ...
            onDrillupAll: function () {
                ...
                // highlight it.
                var last = this.lastDrilledDownPoint, chart = this.chart,
                    series = last && getSeriesFromName(chart, last.seriesName), point;
            ...
            onKbdVertical: function (handler, keyCode) {
                var chart = this.chart, keys = this.keyCodes, isNext = keyCode === keys.down || keyCode === keys.right,
        ...
        function getPointAnnotationTexts(point) {
            ...
            var pointLabels = labels
                .filter(function (label) {
                    return inArray(point, label.points) > -1;
                });
    ...
    _registerModule(_modules, 'modules/accessibility/components/SeriesComponent/SeriesDescriber.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/components/AnnotationsA11y.js'], _modules['modules/accessibility/utils/htmlUtilities.js'], _modules['modules/accessibility/utils/chartUtilities.js'], _modules['parts/Tooltip.js']], function (H, U, AnnotationsA11y, HTMLUtilities, ChartUtilities, Tooltip) {
        ...
        var escapeStringForHTML = HTMLUtilities.escapeStringForHTML,
            reverseChildNodes = HTMLUtilities.reverseChildNodes, stripHTMLTags = HTMLUtilities.stripHTMLTagsFromString;
        ...
        function addDummyPointElement(point) {
            var series = point.series, firstPointWithGraphic = findFirstPointWithGraphic(point),
                firstGraphic = firstPointWithGraphic && firstPointWithGraphic.graphic, parentGroup = firstGraphic ?
        ...
        function pointNumberToString(point, value) {
            var chart = point.series.chart, a11yPointOptions = chart.options.accessibility.point || {},
                tooltipOptions = point.series.tooltipOptions || {}, lang = chart.options.lang;
            if (isNumber(value)) {
        ...
        function getPointA11yTimeDescription(point) {
            var series = point.series, chart = series.chart, a11yOptions = chart.options.accessibility.point || {},
        ...
        function getPointXDescription(point) {
            var timeDesc = getPointA11yTimeDescription(point), xAxis = point.series.xAxis || {},
                pointCategory = xAxis.categories && defined(point.category) &&
                    ('' + point.category).replace('<br/>', ' '),
                canUseId = point.id && point.id.indexOf('highcharts-') < 0, fallback = 'x, ' + point.x;
        ...
        function getPointValue(point) {
            var series = point.series, a11yPointOpts = series.chart.options.accessibility.point || {},
                tooltipOptions = series.tooltipOptions || {}, valuePrefix = a11yPointOpts.valuePrefix ||
        ...
        function getPointValueDescription(point) {
            var series = point.series, chart = series.chart, pointValueDescriptionFormat = chart.options.accessibility
                ...
                series.xAxis.options.accessibility.enabled, !chart.angular),
                xDesc = showXDescription ? getPointXDescription(point) : '', context = {
                    point: point,
        ...
        function defaultPointDescriptionFormatter(point) {
            var series = point.series, chart = series.chart, valText = getPointValueDescription(point),
                description = point.options && point.options.accessibility &&
                    point.options.accessibility.description, userDescText = description ? ' ' + description : '',
                seriesNameText = chart.series.length > 1 && series.name ?
                    ' ' + series.name + '.' : '', annotationsDesc = getPointAnnotationDescription(point),
        ...
        function setPointScreenReaderAttribs(point, pointElement) {
            var series = point.series, a11yPointOptions = series.chart.options.accessibility.point || {},
                seriesA11yOptions = series.options.accessibility || {},
        ...
        function defaultSeriesDescriptionFormatter(series) {
            var chart = series.chart, chartTypes = chart.types || [], description = getSeriesDescriptionText(series),
                shouldDescribeAxis = function (coll) {
                    return chart[coll] && chart[coll].length > 1 && series[coll];
                }, xAxisInfo = getSeriesAxisDescriptionText(series, 'xAxis'),
                yAxisInfo = getSeriesAxisDescriptionText(series, 'yAxis'), summaryContext = {
                    name: series.name || '',
                    ix: series.index + 1,
        ...
        function describeSeriesElement(series, seriesElement) {
            var seriesA11yOptions = series.options.accessibility || {},
                a11yOptions = series.chart.options.accessibility, landmarkVerbosity = a11yOptions.landmarkVerbosity;
        ...
        function describeSeries(series) {
            var chart = series.chart, firstPointEl = getSeriesFirstPointElement(series),
                seriesEl = getSeriesA11yElement(series), is3d = chart.is3d && chart.is3d();
            if (seriesEl) {
    ...
    _registerModule(_modules, 'modules/accessibility/components/ZoomComponent.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/AccessibilityComponent.js'], _modules['modules/accessibility/KeyboardNavigationHandler.js'], _modules['modules/accessibility/utils/chartUtilities.js'], _modules['modules/accessibility/utils/htmlUtilities.js']], function (H, U, AccessibilityComponent, KeyboardNavigationHandler, ChartUtilities, HTMLUtilities) {
        ...
        H.Axis.prototype.panStep = function (direction, granularity) {
            var gran = granularity || 3, extremes = this.getExtremes(),
                step = (extremes.max - extremes.min) / gran * direction, newMax = extremes.max + step,
                newMin = extremes.min + step, size = newMax - newMin;
        ...
        extend(ZoomComponent.prototype, /** @lends Highcharts.ZoomComponent */ {
            ...
            recreateProxyButtonAndGroup: function (buttonEl, buttonProp, groupProp, label) {
                ...
                this[buttonProp] = this.createProxyButton(buttonEl, this[groupProp], {
                    'aria-label': label,
                    tabindex: -1
                });
            },
            ...
            onMapKbdTab: function (keyboardNavigationHandler, event) {
                var button, chart = this.chart, response = keyboardNavigationHandler.response,
                    isBackwards = event.shiftKey, isMoveOutOfRange = isBackwards && !this.focusedMapNavButtonIx ||
            ...
            onMapNavInit: function (direction) {
                var chart = this.chart, zoomIn = chart.mapNavButtons[0], zoomOut = chart.mapNavButtons[1],
    ...
    _registerModule(_modules, 'modules/accessibility/components/RangeSelectorComponent.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/AccessibilityComponent.js'], _modules['modules/accessibility/KeyboardNavigationHandler.js'], _modules['modules/accessibility/utils/chartUtilities.js'], _modules['modules/accessibility/utils/htmlUtilities.js']], function (H, U, AccessibilityComponent, KeyboardNavigationHandler, ChartUtilities, HTMLUtilities) {
        ...
        extend(RangeSelectorComponent.prototype, /** @lends Highcharts.RangeSelectorComponent */ {
            ...
            onButtonNavKbdArrowKey: function (keyboardNavigationHandler, keyCode) {
                var response = keyboardNavigationHandler.response, keys = this.keyCodes, chart = this.chart,
            ...
            onButtonNavKbdClick: function (keyboardNavigationHandler) {
                var response = keyboardNavigationHandler.response, chart = this.chart,
            ...
            onInputKbdMove: function (keyboardNavigationHandler, direction) {
                var chart = this.chart, response = keyboardNavigationHandler.response,
    ...
    _registerModule(_modules, 'modules/accessibility/components/InfoRegionsComponent.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/AccessibilityComponent.js'], _modules['modules/accessibility/utils/Announcer.js'], _modules['modules/accessibility/components/AnnotationsA11y.js'], _modules['modules/accessibility/utils/chartUtilities.js'], _modules['modules/accessibility/utils/htmlUtilities.js']], function (H, U, AccessibilityComponent, Announcer, AnnotationsA11y, ChartUtilities, HTMLUtilities) {
        ...
        var unhideChartElementFromAT = ChartUtilities.unhideChartElementFromAT,
            getChartTitle = ChartUtilities.getChartTitle, getAxisDescription = ChartUtilities.getAxisDescription;
        ...
        extend(InfoRegionsComponent.prototype, /** @lends Highcharts.InfoRegionsComponent */ {
            ...
            updateScreenReaderSection: function (regionKey) {
                var chart = this.chart, region = this.screenReaderSections[regionKey],
                    content = region.buildContent(chart),
                    sectionDiv = region.element = (region.element || this.createElement('div')),
            ...
            setScreenReaderSectionAttribs: function (sectionDiv, regionKey) {
                var labelLangKey = ('accessibility.screenReaderSection.' + regionKey + 'RegionLabel'),
                    chart = this.chart, labelText = chart.langFormat(labelLangKey, {chart: chart}),
            ...
            getLongdescText: function () {
                var chartOptions = this.chart.options, captionOptions = chartOptions.caption,
            ...
            getDataTableButtonText: function (buttonId) {
                var chart = this.chart, buttonText = chart.langFormat('accessibility.table.viewAsDataTableButtonText', {
                    chart: chart,
                    chartTitle: getChartTitle(chart)
                });
            ...
            getEndOfChartMarkerText: function () {
                var chart = this.chart,
                    markerText = chart.langFormat('accessibility.screenReaderSection.endOfChartMarker', {chart: chart}),
            ...
            initDataTableButton: function (tableButtonId) {
                var el = this.viewDataTableButton = getElement(tableButtonId), chart = this.chart,
            ...
            getAxesDescription: function () {
                var chart = this.chart, shouldDescribeColl = function (collectionKey, defaultCondition) {
                    ...
                    showYAxes = shouldDescribeColl('yAxis', hasCartesian && hasNoMap), desc = {};
                if (showXAxes) {
    ...
    _registerModule(_modules, 'modules/accessibility/components/ContainerComponent.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js'], _modules['modules/accessibility/utils/htmlUtilities.js'], _modules['modules/accessibility/utils/chartUtilities.js'], _modules['modules/accessibility/AccessibilityComponent.js']], function (H, U, HTMLUtilities, ChartUtilities, AccessibilityComponent) {
        ...
        extend(ContainerComponent.prototype, /** @lends Highcharts.ContainerComponent */ {
            ...
            handleSVGTitleElement: function () {
                var chart = this.chart, titleId = 'highcharts-title-' + chart.index,
    ...
    _registerModule(_modules, 'modules/accessibility/a11y-i18n.js', [_modules['parts/Globals.js'], _modules['parts/Utilities.js']], function (H, U) {
        ...
        function formatExtendedStatement(statement, ctx) {
            var eachStart = statement.indexOf('#each('), pluralStart = statement.indexOf('#plural('),
                indexStart = statement.indexOf('['), indexEnd = statement.indexOf(']'), arr, result;
            ...
            if (pluralStart > -1) {
                var pluralEnd = statement.slice(pluralStart).indexOf(')') + pluralStart,
                    ...
                    pluralArguments = pluralStatement.split(','), num = Number(ctx[pluralArguments[0]]);
                switch (num) {
                    case 0:
            ...
            if (indexStart > -1) {
                var arrayName = statement.substring(0, indexStart),
                    ix = Number(statement.substring(indexStart + 1, indexEnd)), val;
                arr = ctx[arrayName];
                if (!isNaN(ix) && arr) {
                    if (ix < 0) {
