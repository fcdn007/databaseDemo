...
confirm:{_:"Are you sure you wish to delete %d rows?",1:"Are you sure you wish to delete 1 row?"}},error:{system:'A system error has occurred (<a target="_blank" href="//datatables.net/tn/12">More information</a>).'}},formOptions:{bubble:d.extend({},e.models.formOptions,{title:!1,message:!1,buttons:"_basic"}),inline:d.extend({},e.models.formOptions,{buttons:!1}),main:d.extend({},e.models.formOptions)}};var A=function(a,b,c){d.each(b,function(b,d){z(a,d.dataSrc()).each(function(){for(;this.childNodes.length;)this.removeChild(this.firstChild)}).html(d.valFromData(c))})},
