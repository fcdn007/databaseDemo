 ...
 */
            ...
            var update = function (json) {
                ...
                if (json.values) {
                    $.each(json.values, function (key, val) {
                        that.field(key).val(val);
                    });
                }

                // Hide fields to be hidden
                if (json.hide) {
                    that.hide(json.hide);
                }

                // Show fields to be visible
                if (json.show) {
                    that.show(json.show);
                }
        ...
        Editor.prototype.edit = function (row, arg1, arg2, arg3, arg4) {
            ...
            // Some other field in inline edit mode?
            if (this._tidy(function () {
                that.edit(row, arg1, arg2, arg3, arg4);
            })) {
                return this;
            }
        ...
        Editor.prototype.remove = function (rows, arg1, arg2, arg3, arg4) {
            ...
            // Some other field in inline edit mode?
            if (this._tidy(function () {
                that.remove(rows, arg1, arg2, arg3, arg4);
            })) {
                return this;
            }
...
// Row editing
        ...
        Editor.prototype._focus = function (fields, focus) {
            ...
            if (typeof focus === 'number') {
                ...
                if (focus.indexOf('jq:') === 0) {
                    ...
                    field = this.s.fields[focus].focus();
                }
            }
        ...
        Editor.prototype._formOptions = function (opts) {
            ...
            $(document).on('keydown' + namespace, function (e) {
                ...
                var name = el ? el[0].nodeName.toLowerCase() : null;
                ...
                individual: function (identifer, fieldName, fields) {
                    ...
                    if (fields) {
                        if (fieldName) {
                            ...
                            var dataSrc = col.editField || col.mData;
