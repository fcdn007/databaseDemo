# Generated by Django 2.1.7 on 2020-05-27 02:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name',
                 models.CharField(blank=True, db_column='昵称', error_messages={'nick_name_unique': '该昵称已被占用。'},
                                  max_length=35, unique=True)),
                ('email', models.EmailField(error_messages={'email_unique': '该邮箱地址已被占用。'}, max_length=254, unique=True,
                                            verbose_name='邮箱')),
                ('bulk_delete_privilege',
                 models.CharField(blank=True, db_column='批量删除权限', default='无', max_length=35, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('others', models.TextField(blank=True, db_column='备注', null=True)),
                ('index', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, db_column='性别', default=1, max_length=2, null=True)),
                ('age', models.IntegerField(blank=True, db_column='年龄', null=True)),
                ('patientId', models.CharField(blank=True, db_column='住院号', max_length=35, null=True)),
                ('category', models.CharField(blank=True, db_column='癌种', max_length=50, null=True)),
                ('stage', models.CharField(blank=True, db_column='分期', max_length=15, null=True)),
                ('diagnose', models.CharField(blank=True, db_column='诊断', max_length=255, null=True)),
                ('diagnose_others', models.TextField(blank=True, db_column='诊断备注', null=True)),
                ('centrifugation_date', models.DateField(blank=True, db_column='采样日期', null=True)),
                ('hospital', models.CharField(blank=True, db_column='医院编号', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('nick_name',
                 models.ForeignKey(blank=True, db_column='用户昵称', null=True, on_delete=django.db.models.deletion.CASCADE,
                                   related_name='DatabaseRecord_User', to=settings.AUTH_USER_MODEL,
                                   to_field='nick_name')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ExtractInfo',
            fields=[
                ('dna_id', models.CharField(db_column='DNA提取编号', max_length=35, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('singleLB_Pooling_id',
                 models.CharField(blank=True, db_column='测序文库编号', max_length=35, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('sequencing_id',
                 models.CharField(blank=True, db_column='上机文库号', max_length=35, null=True, unique=True)),
                ...
                ('machine_id', models.CharField(blank=True, db_column='机器号', max_length=50, null=True)),
                ('chip_id', models.CharField(blank=True, db_column='芯片号', max_length=50, null=True)),
                ('others', models.TextField(blank=True, db_column='备注', null=True)),
                ('index', models.AutoField(primary_key=True, serialize=False)),
                ('last_modify_date', models.DateTimeField(auto_now=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
